...
Instalacion local del cliente de github.

**REQUERIMIENTOS**

Sistema de linux Ubuntu. <br>
Acceso en linea a Github en https://github.com
...
Para usar un repositorio que ya existe, solo tenemos que clonarlo usando el cliente the git.
```
