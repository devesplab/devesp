...
# LINUX :: Permisos :: Ficheros y Directories
...
En esta leccion: Permisos De Ficheros y Directorios
- Entender que son permisos y propiedades de Ficheros
- Entender Umask
- Ver para que sirve establecer permisos de ficheros
- Utilidades nativas disponibles en Linux para establecer permisos de Ficheros y Directorios
...
Sistema de linux Ubuntu o RedHat. <br>

**ADVERTENCIA**

Es buena práctica establecer permisos de **menor privilegio** posible para Ficheros y Directorios.
...
Pero, cuál es el origen de esos valores numéricos? El tópico siguiente lo explica.
...
### Permisos for defecto de Carpetas
...
### Permisos for defecto de Ficheros
...
El el caso anterior, hemos usado el valor octal (numérico) para establecer permisos. Si lo deseamos, en vez de números, podemos usar la letra correspondiente y el resultado será el mismo.
- u = usuario
- g = grupo
- o = otros
